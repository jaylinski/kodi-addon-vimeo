...
from .utils import m3u8_without_av1, webvtt_to_srt
...
class Api:
    ...
    def _hls_playlist_without_av1_streams(self, playlist):
        ...
        self.vfs_cache.write("original.m3u8", hls_master_playlist)  # TODO remove
        ...
        xbmc.log("plugin.video.vimeo::Api() Original HLS playlist: " + playlist, xbmc.LOGDEBUG)
